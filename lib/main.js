...
(function() {
  var $, $as_line, $async, $show, $split, CND, D, FS, O, PATH, V8PROFILER, badge, debug, flamegraph, flamegraph_from_stream, format_float, format_integer, help, info, new_numeral, report, rpr, running_in_devtools, start_profile, step, stop_profile, through2, warn, whisper, write_flamegraph;
  ...
  stop_profile = function(run_name, handler) {
    if (running_in_devtools) {
  ...
  write_flamegraph = function(run_name, handler) {
    ...
    /*
     */
    var callgraph_lines, flamegraph_name, profile_name, source;
    if (running_in_devtools) {
      return;
    }
