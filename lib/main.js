...
(function() {
  var $as_line, $show, $split, CND, FS, O, PATH, badge, debug, format_float, format_integer, help, info, new_numeral, rpr, running_in_devtools, start_profile, step, stop_profile, through2, warn, whisper;
    ...
    return step((function(_this) {
      return function*(resume) {
        ...
        for (run = i = 1; i <= 1; run = ++i) {
          yield _this.read_with_transforms(0, input_name, mode, resume);
          yield _this.read_with_transforms(100, input_name, mode, resume);
          yield _this.read_with_transforms(200, input_name, mode, resume);
          yield _this.read_with_transforms(300, input_name, mode, resume);
        }
        if (running_in_devtools) {
