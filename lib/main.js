...
(function() {
  var $, $as_line, $async, $show, $split, CND, D, FS, O, PATH, V8PROFILER, badge, debug, echo, flamegraph, flamegraph_from_stream, format_float, format_integer, help, info, new_numeral, new_spin, report, rpr, running_in_devtools, start_profile, step, stop_profile, through2, warn, whisper, write_flamegraph;
  ...
  stop_profile = function(S, handler) {
    if (running_in_devtools) {
      ...
      return step(function*(resume) {
        var profile, profile_data, profile_path;
  ...
  write_flamegraph = function(S, handler) {
    var callgraph_lines, flamegraph_path, source;
    if (running_in_devtools) {
      return;
    }
