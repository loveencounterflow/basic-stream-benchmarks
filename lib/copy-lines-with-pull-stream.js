...
(function() {
  var $logger, $map, $on_end, $random, $sequence, $split, $stringify, $utf8, CND, FS, O, PATH, badge, count, debug, echo, format_float, format_integer, help, id, info, input, mkdirp, new_numeral, output, parseCsv, paths, pipeline, prop, pull, rpr, t0, t1, through, through2, to_pull, urge, values, warn, whisper, þ;
...
;
  ...
  þ(to_pull.sink(output, function(error) {
    var dts, ips;
    if (error != null) {
      throw error;
    }
